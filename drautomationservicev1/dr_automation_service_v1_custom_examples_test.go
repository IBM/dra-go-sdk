	...
	Describe(`DrAutomationServiceV1 request examples`, func() {
		...
		It(`ServiceInstanceManageDr HA with sshkey`, func() {
			...
			createManageDrOptions := drAutomationServiceService.NewCreateManageDrOptions(
				"050ebe3b-13f4-4db8-8ece-501a3c13be80mh1", // instanceID
				"dal10",                                // locationID
				"s922",                                 // machineType
				"off-premises",                         // orchestratorLocationType
				"drautomationprimarymh1",               // orchestratorName
				"EverytimeNewPassword@1",               // orchestratorPassword
				"75cbf05b-78f6-406e-afe7-a904f646d798", // orchestratorWorkspaceID
			)
		...
		It(`ServiceInstanceManageDr HA with secrets`, func() {
			...
			createManageDrOptions := drAutomationServiceService.NewCreateManageDrOptions(
				"050ebe3b-13f4-4db8-8ece-501a3c13be80mh3", // instanceID
				"dal10",                                // locationID
				"s922",                                 // machineType
				"off-premises",                         // orchestratorLocationType
				"drautomationprimarymh3",               // orchestratorName
				"EverytimeNewPassword@1",               // orchestratorPassword
				"75cbf05b-78f6-406e-afe7-a904f646d798", // orchestratorWorkspaceID
			)
			createManageDrOptions.SetOrchestratorHa(true)
		...
		It(`ServiceInstanceManageDr Non-HA with sshkey`, func() {
			...
			createManageDrOptions := drAutomationServiceService.NewCreateManageDrOptions(
				"050ebe3b-13f4-4db8-8ece-501a3c13be80mnh5", // instanceID
				"dal10",                                // locationID
				"s922",                                 // machineType
				"off-premises",                         // orchestratorLocationType
				"drautomationprimarymnh5",              // orchestratorName
				"EverytimeNewPassword@1",               // orchestratorPassword
				"75cbf05b-78f6-406e-afe7-a904f646d798", // orchestratorWorkspaceID
			)
		...
		It(`ServiceInstanceManageDr Non-HA with secrets`, func() {
			...
			createManageDrOptions := drAutomationServiceService.NewCreateManageDrOptions(
				"c050ebe3b-13f4-4db8-8ece-501a3c13be80mnh7", // instanceID
				"dal10",                                // locationID
				"s922",                                 // machineType
				"off-premises",                         // orchestratorLocationType
				"drautomationprimarymnh7",              // orchestratorName
				"EverytimeNewPassword@1",               // orchestratorPassword
				"75cbf05b-78f6-406e-afe7-a904f646d798", // orchestratorWorkspaceID
			)
			createManageDrOptions.SetOrchestratorHa(false)
