...
// demo-go-sdk/0.0.1 (lang=go; arch=x86_64; os=Linux; go.version=1.12.9)
//
// In the example above, the analytics tool will parse the user-agent header and
// use the following properties:
// "demo-go-sdk" - the name of your sdk
...
func GetComponentInfo() *core.ProblemComponent {
	...
	return core.NewProblemComponent("github.com/IBM/dra-go-sdk", Version)
}
